...
#if WINDOWS_PHONE
        // NOTE: Updated for new types.
        private static void sensor_ReadingChanged(object sender, SensorReadingEventArgs<AccelerometerReading> e)
        {
            // store the accelerometer value in our variable to be used on the next Update
            lock (threadLock)
            {
                // ALVIN NOTE: Updated to use accelerometer reading.
